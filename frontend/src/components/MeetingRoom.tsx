    ...
    <div className="meeting-room-overlay" style={{ background: 'rgba(30,32,24,0.98)', minHeight: '100vh', padding: 0 }}>
      <div className="meeting-room-modal" style={{ maxWidth: 900, margin: 'auto', borderRadius: 16, boxShadow: '0 4px 32px #000a', background: '#23241a', display: 'flex', flexDirection: 'row', overflow: 'hidden' }}>
        ...
        <div className="meeting-room-side" style={{ flex: 1, background: '#23241a', padding: 24, display: 'flex', flexDirection: 'column', gap: 20, borderRight: '1.5px solid #ffe06622', minWidth: 0, boxSizing: 'border-box' }}>
          ...
          <div style={{ display: 'flex', gap: 10, marginTop: 8, flexWrap: 'wrap', paddingRight: 3, justifyContent: window.innerWidth > 700 ? 'flex-end' : 'flex-start', alignItems: 'center' }}>
        ...
        {/* Right: Chat */}
        <div className="meeting-room-chat" style={{ flex: 2, background: '#181910', padding: 24, display: 'flex', flexDirection: 'column', minWidth: 0, boxSizing: 'border-box' }}>
